...
export default class NewComponent extends Template{
	...
	__setupDefinitions() {
		...
		/*
		3Duf contains the curved mixer part.
		However, it has two curvatures instead of one. So it would be great if there was a half-curved mixer part.
		This feature could be a part of some PCR devices.
		*/
		/*heritable part stay same as the original curvedMixer template*/
			this.__heritable = {
